...
func TestTableCreateBindAndDelete(t *testing.T) {
	...
	updated, err := table.BindHomeControl(sess.ID, 2222)
	if err != nil {
...
func TestCleanupExpiredDeletesSession(t *testing.T) {
	...
	sess := table.Create(visited, "198.51.100.10:2123", "001010123456789", "internet", "apn", "internet", "pgw", 1111, time.Millisecond)
